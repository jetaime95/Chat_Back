...
urlpatterns = [
    ...
    path('find-password/', views.PasswordResetEmailView.as_view(), name='find_password'),
    path('find-password-verify/', views.PasswordResetVerifyCodeView.as_view(), name='find_password_verify'),
    path('find-password-reset/', views.PasswordResetView.as_view(), name='find_password_reset'),
